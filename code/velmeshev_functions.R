...
if(add_node == F){
graph.new <- igraph:add_edges(graph.old, c(node1, node2))
}
else{
...
graph.new <- igraph:add_edges(graph.new, c(node1, new_name))
graph.new <- igraph:add_edges(graph.new, c(new_name, node2))
}
